...
#cl = LineClient("udimarsudi9@gmail.com","9667") #login via email
#cl = LineClient(authToken='ECObdPZSpSerwwJ2rG02.judyzdUH7VmsfDiUleBNGG.7X1c4FkfCyKXeZsJvR4ImdSsz35p52wHGhXBr+hq8LQ=') 
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "u2540d8643ba1eef31215d22e2c46e782")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendMessage(msg.to, "sᴇʟғ 𝓶&𝓻 ᴅɪᴀᴋᴛɪғᴋᴀɴ")
                                
                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendMessage(msg.to, "sᴇʟғ 𝓶&𝓻 ᴅɪ ɴᴏɴᴀᴋᴛɪғᴋᴀɴ")
                        ...
                        if cmd == "help4":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                zx2.append(zx)
                                zxc += pesan2
                                text = xpesan + zxc + ret_ + "┝────────────────\n│♠ 𝓶&𝓻 ᴄʟᴏᴄᴋ: 「"+ datetime.strftime(timeNow,'%H:%M:%S')+"」 "+"\n│♠ 𝓶&𝓻 ᴅᴀᴛᴇ: 「"+ datetime.strftime(timeNow,'%Y-%m-%d') +"」\n╰────ஜ۩𝓶&𝓻۩ஜ─────╯"
                                cl.sendMessage(msg.to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)

                        elif cmd == "creator" or text.lower() == 'creator':
                            if msg._from in admin:
                                cl.sendMessage(msg.to,"🔳🔳ᴄʀᴇᴀᴛᴏʀ 𝓶&𝓻ˢᴱᴸᶠ🔲🔲") 
                                ma = "ue048b0384f94eb15822ea77754af6e2f"
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for group in saya:
                                   cl.sendMessage(group,"[🔳𝓶&𝓻 sʜᴀʀᴇ🔲]\n" + str(pesan))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention1(msg.to, sender,"╔────ஜ۩𝓶&𝓻_sᴇʟғ۩ஜ─────╗\n│ᴡᴀɪᴛing ʙᴏss..\n│ᴘʀᴏɢʀᴇss ʀᴇsᴛᴀʀᴛ\n│ᴜsᴇʀ: ", " \n│ °𝓶&𝓻 ʀᴇsᴛᴀʀᴛ° ᴅᴏɴᴇ°\n╚────ஜ۩𝓶&𝓻_sᴇʟғ۩ஜ─────╝")
...
#====================================================================   
                           ...
                           if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to, '𝓶&𝓻 ᴅᴏɴᴇ ʟɪᴋᴇ ᴀɴᴅ ᴄᴏᴍᴍᴇɴᴛ '+str(len(st))+' ᴘᴏsᴛ ғʀᴏᴍ' + str(s))
                                except Exception as e:
                                    cl.sendMessage(msg.to, str(e))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "𝓶&𝓻 sᴘᴇᴇᴅ ʀᴇsᴘᴏɴ\n\n - ɢᴇᴛ ᴘʀᴏғɪʟᴇ:\n%.10f\n - ɢᴇᴛ ᴄᴏɴᴛᴀᴄᴛ:\n%.10f\n - ɢᴇᴛ ɢʀᴏᴜᴘ\n%.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "╔────ஜ۩𝓶&𝓻_sᴇʟғ۩ஜ─────╗\n│  🔳ᴄᴇᴋ sɪᴅᴇʀ 𝓶&𝓻 ᴏɴ🔲\n┝───────────────────\n│🔳ᴛᴀɴɢɢᴀʟ: "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n│🔲ᴊᴀᴍ:  "+ datetime.strftime(timeNow,'%H:%M:%S')+"\n╚────ஜ۩𝓶&𝓻_sᴇʟғ۩ஜ─────╝")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = True
                                sendMention(msg.to, sender, "   sᴛᴀᴛᴜs ᴛɪᴍᴇʟɪɴᴇ 𝓶&𝓻\nᴜsᴇʀ: @! \nsᴇɴᴅ ʏᴏᴜʀ ᴘᴏsᴛ,\nʟɪᴋᴇ ᴅᴏɴᴇ-> ᴛᴏ ᴏғғ: ᴛɪᴍᴇʟɪɴᴇ ᴏғғ")
...
#===========COMMAND SET============#
                           ...
                           if wait["Timeline"] == True:
                              ...
                              cl.sendMessage(msg.to, "𝓶&𝓻 ʟɪᴋᴇ ᴅᴏɴᴇ ʙᴏss")
